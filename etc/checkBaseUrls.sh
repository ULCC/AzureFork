...
BASE_TEMPLATE_URL=https://raw.githubusercontent.com/ULCC/AzureFork/$CURRENT_BRANCH/nested/
echo "Base template URL: $BASE_TEMPLATE_URL"

SCRIPT_LOCATION=https://raw.githubusercontent.com/ULCC/AzureFork/$CURRENT_BRANCH/scripts/
echo "Script location: $SCRIPT_LOCATION"

DEPLOY_TO_AZURE_URL=https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FULCC%2FAzureFork%2F$CURRENT_BRANCH%2Fazuredeploy.json
echo "Deploy to Azure URL: $DEPLOY_TO_AZURE_URL"

VISUALIZE_URL=http://armviz.io/#/?load=https%3A%2F%2Fraw.githubusercontent.com%2FULCC%2FAzureFork%2F$CURRENT_BRANCH%2Fazuredeploy.json
